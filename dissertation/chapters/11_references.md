...
Abkenar, M. Y., Wang, W., Graupner, H. and Stede, M. (2024). Assessing Open-Source Large Language Models on Argumentation Mining Subtasks. arXiv:2411.05639.
...
Beale, R. (2025). Adapting University Policies for Generative AI: Opportunities, Challenges, and Policy Solutions in Higher Education. arXiv:2506.22231.

Church, I. M., Drake, L. and Harris, M. (2025). Using LLMs to support assessment of student work in higher education: a viva voce simulator. arXiv:2511.05530.
...
Delphino, K. (2025). Assessing the Prevalence of AI-assisted Cheating in Programming Courses: A Pilot Study. arXiv:2507.06438.
...
Fu, W., Wei, B., Hu, J., Cai, Z. and Liu, J. (2024). QGEval: Benchmarking Multi-dimensional Evaluation for Question Generation. arXiv:2406.05707.

Gorichanaz, T. (2023). Accused: How students respond to allegations of using ChatGPT on assessments. arXiv:2308.16374.
...
Hans, A., Schwarzschild, A., Cherepanova, V., Kazemi, H., Saha, A., et al. (2024). Spotting LLMs With Binoculars: Zero-Shot Detection of Machine-Generated Text. In Proceedings of the 41st International Conference on Machine Learning (ICML 2024), PMLR 235. arXiv:2401.12070.
...
Ipeirotis, P. and Rizakos, K. (2026). Scalable and Personalized Oral Assessments Using Voice AI. arXiv:2603.18221.
...
Kirchenbauer, J., Geiping, J., Wen, Y., Katz, J., Miers, I. and Goldstein, T. (2023). A Watermark for Large Language Models. In Proceedings of the 40th International Conference on Machine Learning (ICML 2023), PMLR 202, pp. 17061 to 17084.

Koike, R., Kaneko, M. and Okazaki, N. (2024). OUTFOX: LLM-Generated Essay Detection Through In-Context Learning with Adversarially Generated Examples. In Proceedings of the AAAI Conference on Artificial Intelligence, 38(19), pp. 21258 to 21266.
...
Kurdi, G., Leo, J., Parsia, B., Sattler, U. and Al-Emari, S. (2020). A Systematic Review of Automatic Question Generation for Educational Purposes. International Journal of Artificial Intelligence in Education, 30(1), pp. 121 to 204.

Lee, T., Lee, S. and Kim, S. (2025). Beyond Static Scoring: Enhancing Assessment Validity via AI-Generated Interactive Verification. arXiv:2512.12592.

Li, H., Schlegel, V., Sun, Y., Batista-Navarro, R. and Nenadic, G. (2025). Large Language Models in Argument Mining: A Survey. arXiv:2506.16383.
...
Liusie, A., Raina, V. and Gales, M. (2022). World Knowledge in Multiple Choice Reading Comprehension. arXiv:2211.07040.
...
Lyu, Q., Apidianaki, M. and Callison-Burch, C. (2024). Towards Faithful Model Explanation in NLP: A Survey. Computational Linguistics, 50(2), pp. 657 to 723.
...
Nguyen, B., Yu, M., Huang, Y. and Jiang, M. (2024). Reference-based Metrics Disprove Themselves in Question Generation. arXiv:2403.12242.
...
Sotiriadou, P., Logan, D., Daly, A. and Guest, R. (2020). The Role of Authentic Assessment to Preserve Academic Integrity and Promote Skill Development and Employability. Studies in Higher Education, 45(11), pp. 2132 to 2148.
